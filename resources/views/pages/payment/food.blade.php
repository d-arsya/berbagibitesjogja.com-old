    ...
    <form method="POST" action="{{ route('payment.foodStore') }}" class="max-w-md mx-auto shadow-md px-10  py-6 rounded-b-md">
        ...
        <div class="relative z-0 w-full mt-8 group">
            ...
            <div class="relative z-0 w-full mt-8 group">
                ...
                <label for="take"
                    class="peer-focus:font-medium absolute text-md text-gray-700 duration-300 transform -translate-y-8 scale-75 top-2 left-6 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-8">Tanggal Pengambilan</label>
            </div>
