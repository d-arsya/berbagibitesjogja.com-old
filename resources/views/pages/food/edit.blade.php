        ...
        <div class="w-full md:w-1/3">
            ...
            <div class="shadow-md p-5 rounded-md mt-5">
                ...
                <form class="max-w-sm mx-auto" action="{{ route('food.update',$food->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <input type="text" id="disabled-input" aria-label="disabled input" class="mb-5 bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed" value="{{ $donation->sponsor()->name }} ({{ $donation->take }})" disabled>
