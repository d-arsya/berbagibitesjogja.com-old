...
@section('container')
    ...
    <div class="flex flex-col items-center">
        <div class="w-full max-w-sm p-6 bg-white rounded-lg shadow-md">
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-center mb-2">
                        ...
                        <span class="flex items-center text-sm leading-5 text-gray-500 cursor-pointer" id="togglePassword">
                            <i class="fas fa-eye-slash mr-2"></i> Tampilkan
                        </span>
                    </div>
                    <input
                        class="w-full px-3 py-2 text-sm border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div class="mt-4 text-center">
                <a class="text-sm font-medium text-gray-700 hover:underline" href="">Lupa kata
                    sandi?</a>
            </div>
        </div>
    ...
    <script>
        ...
        togglePassword.addEventListener('click', function(e) {
            ...
            if (type === 'password') {
                togglePassword.innerHTML = '<i class="fas fa-eye-slash mr-2"></i> Tampilkan';
            } else {
                togglePassword.innerHTML = '<i class="fas fa-eye mr-2"></i> Sembunyikan';
            }
        });
    </script>
@endsection
