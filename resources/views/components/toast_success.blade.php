<div id="toast-success"
    class="fixed z-50 hidden right-5 top-12 md:top-5 mb-4 flex w-full max-w-xs items-center rounded-lg bg-white p-4 text-gray-500 shadow light:bg-gray-800 light:text-gray-400"
    role="alert">
    <div
